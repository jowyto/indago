...
abstract class BaseFormato extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FormatoPeer::ID;
        }
    ...
    public function setFormato($v)
    {
        ...
        if ($this->formato !== $v) {
            $this->formato = $v;
            $this->modifiedColumns[] = FormatoPeer::FORMATO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->formato = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FormatoPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(FormatoPeer::FORMATO)) {
            $modifiedColumns[':p' . $index++]  = '`FORMATO`';
        }

        $sql = sprintf(
            'INSERT INTO `formato` (%s) VALUES (%s)',
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setFormato($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FormatoPeer::ID)) $criteria->add(FormatoPeer::ID, $this->id);
        if ($this->isColumnModified(FormatoPeer::FORMATO)) $criteria->add(FormatoPeer::FORMATO, $this->formato);
    ...
    {
        $criteria = new Criteria(FormatoPeer::DATABASE_NAME);
        $criteria->add(FormatoPeer::ID, $this->id);
    ...
    public function setDatasets(PropelCollection $datasets, PropelPDO $con = null)
    {
        ...
        foreach ($this->datasetsScheduledForDeletion as $datasetRemoved) {
            $datasetRemoved->setFormato(null);
        }
     ...
     * @return PropelObjectCollection|Dataset[] List of Dataset objects
     */
    public function getDatasetsJoinCompresion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = DatasetQuery::create(null, $criteria);
        $query->joinWith('Compresion', $join_behavior);
